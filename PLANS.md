...
| WP08 release evidence and deployment | ACTIVE | Produce exact candidate images and complete requirement traceability, production-clone migration/performance/archive, backup/restore, candidate deployment, Tier 3 live archive, persistence, and rollback gates before declaring the release complete. |
